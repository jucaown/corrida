...
function preload(){
  ...
  mainRacerImg1 = loadAnimation("mainPlayer2.png");
  ...
  oppRed1Img = loadAnimation("opponent8.png");
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    //Acrescente o código para mostrar o texto da instrução restart (reiniciar) aqui
     ...
     fill("red");
     textSize(50);
     text("aperte o botão R para reiniciar!", 200,100);
